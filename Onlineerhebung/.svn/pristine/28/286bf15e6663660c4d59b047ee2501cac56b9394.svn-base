	...
	<g:form method="post" >
	  	<div id="info">
	   		<h1>
	   			<span class="float-left">
	   				<g:actionSubmit class="invisible" action="erfassung1KorrekturSpeichern" value="${message(code:
		    		...
		    		<g:if test="${session.user == grailsApplication.config.emikat.admin.name || session.user == grailsApplication.config.emikat.support.name}">
						<g:actionSubmit class="button" action="erfassung1KorrekturUebersicht"
				...
				<g:actionSubmit class="float-right logout button" action="erfassung1KorrekturLogout"
		...
		<div id="navigation">
			<g:if test="${session.editierbar}">
				<span class="float-left">
					<g:actionSubmit class="button" action="erfassung1KorrekturSpeichern" value="${message(code:
						'at.emikat.gemerh.ooe.button.speichern', default: 'Speichern')}" />
				</span>
			</g:if>
		
			<span class="float-right">
				<g:actionSubmit class="button" action="erfassung1KorrekturAbgabe" value="${message(code:
